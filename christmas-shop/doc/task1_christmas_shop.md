...
You need to create Home and Gifts pages according to the Design in Figma - only Home / w1440 and Gifts / w1440.
The content width of 1440px should not change when resizing the browser window.

Workflow
The task should be completed in private repository of the school.
