...
You need to create Home and Gifts pages according to the Design in Figma - only Home / w1440 and Gifts / w1440. The content width of 1440px should not change when resizing the browser window.

Workflow
The task should be completed in private repository of the school. How to work with a school's private repository
Create a new branch named christmas-shop from main branch. Create a folder christmas-shop in the created branch. Place your code in this folder.
Complete the task.
Ensure your work meets the CrossCheck Criteria.
Independently evaluate your work according to the provided Criteria for Evaluation, keeping in mind the Specifics of Verifying Layout.
Deploy your work to gh-pages. For example, create and merge a Pull Request from the christmas-shop branch into gh-pages branch. The title of the Pull Request can be chosen at your discretion. A description for this Pull Request is not necessary.
Once you have completed your work, open a Pull Request from the christmas-shop branch to the main branch. Give the Pull Request a title based on the task name. Provide a description for the Pull Request following template. There is no need to merge this Pull Request.
Submit the deployment link of your project in the "Cross-Check Submit" section of the RS APP.
After the task deadline has passed, the cross-check phase will start, lasting three days. To earn points for the task, you must review all the projects assigned to you for cross-checking and submit your review results in the "Cross-Check Review" section of the RS APP.
